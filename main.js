...
function initSlideshow(container, interval) {
    const track = container.querySelector('.mini-track') || container.querySelector('.slideshow-track');
    const slides = Array.from(container.querySelectorAll('.mini-slide, .slide'));
    const dotsWrap = container.querySelector('.mini-dots') || container.querySelector('.slide-dots');
    const prevBtn = container.querySelector('.mini-prev') || container.querySelector('.slide-prev');
    const nextBtn = container.querySelector('.mini-next') || container.querySelector('.slide-next');
